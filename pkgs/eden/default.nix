...
let
  ...
  nx_tzdb = stdenv.mkDerivation (finalAttrs: {
    ...
    src = fetchurl {
      url = "https://github.com/lat9nq/tzdb_to_nx/releases/download/${finalAttrs.version}/${finalAttrs.version}.zip";
...
stdenv.mkDerivation (finalAttrs: {
  ...
  meta = {
    description = "Modern FOSS Nintendo Switch Emulator focusing on performance and reliability";
